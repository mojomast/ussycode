...
func (ap *AuthProxy) Handler() http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		// Look up the VM owner
		owner, err := ap.db.UserByID(ctx, vm.UserID)
		if err != nil {
			ap.logger.Error("failed to look up VM owner", "vm", vmName, "error", err)
...
func (ap *AuthProxy) setAuthHeaders(w http.ResponseWriter, user *db.User, vm *db.VM) {
